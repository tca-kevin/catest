 ...
 *
 * Modified by WebDevStudios on 28-February-2023 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */

if ( ! class_exists( 'WPSWAP_EDD_SL_Plugin_Updater' ) ) {
	 ...
	 * @version 1.9.1
	 */
	class WPSWAP_EDD_SL_Plugin_Updater {
		 ...
		 *
		 * @see WPSWAP_EDD_SL_Plugin_Updater::request_recently_failed
		 *
		 * @since 1.9.1
		 */
